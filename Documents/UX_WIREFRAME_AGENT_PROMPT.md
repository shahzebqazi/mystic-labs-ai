...
- **System:** dotAi — markdown-first agent orchestration. No protocol servers; files and jj commits are the protocol. See `Project/README.md` and `Project/START_HERE.md`.
...
- `Project/START_HERE.md` — Entry point, rules, tasks, bootstrap.
- `Project/Orchestration/Memories/system/runtime.md`, `system/model_serving.md` — Runtime (OS, GPU, model endpoint, llama-server).
- `Project/Documents/PRDs/FEATURES_PRD.md` — Settings, backend URL, model, execution level, session restore, personas.
- `Project/Documents/PRDs/MVP_PRD.md` — MVP gate (Ollama/backend works locally), success criteria.
- `Project/Orchestration/Tasks/SWE/CHATBOT.md` — Chatbot capabilities and behavior.
...
1. **Align with the project**  
   Read and use: `Project/README.md`, `Project/START_HERE.md`, `Project/Orchestration/Memories/system/` (runtime.md, model_serving.md), `Project/Documents/PRDs/FEATURES_PRD.md`, `Project/Documents/PRDs/MVP_PRD.md`, and `Project/Orchestration/Tasks/SWE/CHATBOT.md`. Respect local-first, no telemetry, and the base-repo guidelines.
