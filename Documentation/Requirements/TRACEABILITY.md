...
**User stories:** `Documents/UserStories/USER_STORIES.md`  
**Functional requirements:** `Documents/Requirements/Functional/FUNCTIONAL_REQUIREMENTS.md`  
**Non-functional requirements:** `Documents/Requirements/NFR/NON_FUNCTIONAL_REQUIREMENTS.md`
